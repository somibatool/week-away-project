  ...
  return (
    <div className='max-w-[1140px] m-auto w-full md:flex mt=[-75px]'>  
      <div className='relative p-4'>
        <h3 className='absolute z-20 top=[50%] left-[50%] translate-x-[-50%]  translate-y-[-50%] text-2xl text-white font-bold mt-5'>Resorts</h3>
      ...
      <div className='relative p-4'>
        <h3 className='absolute z-10 top=[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] text-2xl text-white font-bold mt-5'>Resorts</h3>
